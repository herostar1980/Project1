...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 27, 2020 lúc 08:23 AM
...
(1, 'CLOUD PRINT T-SHIRT', 1, 1, '', 1, 35, '2020-11-20 14:02:53', 'This exceptional piece channels the collection\'s reengineering of corporate dress codes, with a deconstructed version of the traditional suit jacket. Tailored from wool twill in a regular fit, it is broken up into pieces and reassembled with embroide'),
(2, 'SCULPTURAL JACKET', 2, 1, '', 1, 15, '2020-11-20 14:02:53', 'This exceptional piece channels the collection\'s reengineering of corporate dress codes, with a deconstructed version of the traditional suit jacket. Tailored from wool twill in a regular fit, it is broken up into pieces and reassembled with embroide'),
(3, 'EMBOSSED CLOUDS 90S SLIM PANTS', 15, 1, '', 0, 0, '2020-11-20 14:02:53', 'This exceptional piece channels the collection\'s reengineering of corporate dress codes, with a deconstructed version of the traditional suit jacket. Tailored from wool twill in a regular fit, it is broken up into pieces and reassembled with embroidered yarn, creating a sculptural effect. The back i'),
...
--
ALTER TABLE `productdetail`
  MODIFY `idProductDetail` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id Product Detail', AUTO_INCREMENT=4;
