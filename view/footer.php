<footer>
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo">
                                    <a href="home.php"><img src="../view/assets/img/logo/logo.svg" alt="logo"></a>
                                </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | LuonVuiTuoi with <i class="fa fa-heart" aria-hidden="true"></i> by LuonVuiTuoi
